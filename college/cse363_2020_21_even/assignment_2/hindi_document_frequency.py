...
for document in book:
    ...
    if os.path.isfile(document_path):
        try:
            ...
            tokens_set = set(tokens)  # Only keep unique values
            tokens_all = tokens_all.union(tokens_set)

            document_dict = {}  # Dictionary containing tokens (of a specific document) mapped to their count
            ...
            document_index[document_id] = document  # Map name of document to a number
...
df.to_excel("hindi_doc_frequency.xlsx")
